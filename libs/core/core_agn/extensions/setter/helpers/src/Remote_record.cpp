...
Logic::Remote_record::Remote_record(Port_settings_storage &&port_settings, Remote_conf_port conf_port)
    : port_settings{std::move(port_settings)}, Remote_conf_port_rec{conf_port}
{
}
