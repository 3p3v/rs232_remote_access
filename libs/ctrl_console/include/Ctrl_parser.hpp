...
namespace Cmd_ctrl
{
    ...
    class Ctrl_parser : protected Common_defs //, protected Ctrl_con_defs
    {
    ...
    // template <Endl_opt endl_opt, char endl, char space>
    // template <typename Iter_t>
    // Ctrl_parser<endl_opt, endl, space>::Ctrl_cmd_pos_con Ctrl_parser<endl_opt, endl, space>::parse(const typename Iter_t begin, const typename Iter_t end)
    // {
    //     Ctrl_cmd_pos_con lines;
    //     find_lines(lines, begin, end);
    //     return lines;
