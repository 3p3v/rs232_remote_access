...
#define CONFIG_ESP_SYSTEM_EVENT_TASK_STACK_SIZE 2000
...
#define CONFIG_MBEDTLS_SSL_OUT_CONTENT_LEN 6144
#define CONFIG_MBEDTLS_DEBUG 1
#define CONFIG_MBEDTLS_DEBUG_LEVEL_DEBUG 1
#define CONFIG_MBEDTLS_DEBUG_LEVEL 3
