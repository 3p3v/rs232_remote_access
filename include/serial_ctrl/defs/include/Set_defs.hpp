...
namespace Logic
{
    ...
    public:
        ...
        static std::string parity_trans(Port_settings::Parity parity);
        static std::string char_size_trans(Port_settings::Char_size baud_rate);
        // static std::string flow_ctrl_trans(Port_settings::Flow_ctrl flow_ctrl);
        static std::string stop_bits_trans(Port_settings::Stop_bits stop_bits);
