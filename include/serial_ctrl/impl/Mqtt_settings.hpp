...
namespace Impl
{
    ...
    template <typename Cont_t, typename Ok_callb, typename Ec_callb>
    inline void Mqtt_settings::write_i(Cont_t &&msg, Ok_callb &&ok_callb, Ec_callb &&ec_callb)
    {
    ...
    template <typename Cont_t, typename Arg_cont_t, typename Ok_callb, typename Ec_callb>
    inline void Mqtt_settings::write_i(Cont_t &&msg, Arg_cont_t &&arg, Ok_callb &&ok_callb, Ec_callb &&ec_callb)
    {
    ...
    template <typename Cont_t, typename Ok_callb, typename Ec_callb>
    inline void Mqtt_settings::write_s(Cont_t &&msg, Ok_callb &&ok_callb, Ec_callb &&ec_callb)
    {
        auto msg_ptr = std::make_unique<std::string>(std::string{msg} + "\n");
    ...
    template <typename Cont_t, typename Arg_cont_t, typename Ok_callb, typename Ec_callb>
    inline void Mqtt_settings::write_s(Cont_t &&msg, Arg_cont_t &&arg, Ok_callb &&ok_callb, Ec_callb &&ec_callb)
    {
        auto msg_ptr = std::make_unique<std::string>(std::string{msg} + " " + std::string{arg} + "\n");
    ...
    template <typename Ok_callb, typename Ec_callb>
    inline void Mqtt_settings::connect(Ok_callb &&ok_callb, Ec_callb &&ec_callb)
    {
        try
        {
    ...
    template <typename Ok_callb, typename Ec_callb>
    inline Mqtt_settings::Mqtt_settings(const Device &device, Mqtt_port::Impl::Controller &controller)
