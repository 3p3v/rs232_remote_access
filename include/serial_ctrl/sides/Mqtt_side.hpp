...
template <typename Impl>
template <typename Cont_t, typename Ok_callb, typename Ec_callb>
inline void Mqtt_side<Impl>::write(unsigned char id, const typename Cont_t::const_iterator begin, const typename Cont_t::const_iterator end, Ok_callb &&ok_callb, Ec_callb &&ec_callb)
{
    impl.write<Cont_t>(
        id,
        begin,
